...
control ingress(inout headers_t hdr,
    ...
    apply {
        ...
        tsn_queue_control.apply(hdr, local_metadata, standard_metadata);
...
control egress(inout headers_t hdr,
    ...
    apply {
        ...
        tsn_debug_egress_control.apply(hdr, local_metadata, standard_metadata);
